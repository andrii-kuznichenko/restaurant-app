          ...
          {admin ? (
            <>
              ...
              <aside
                ...
                } fixed top-0 left-0 z-30 h-screen pt-20 transition-transform bg-white border-r border-gray-200  dark:bg-gray-800 dark:border-gray-700`}
                aria-label="Sidebar"
              >
              ...
              <div className="p-4" style={{ marginLeft: isSidebarOpen ? "16rem" : "0rem" }}>
                <Outlet />
              </div>
