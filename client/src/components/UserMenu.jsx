                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                <img
                                  src={item.image}
                                  className="max-w-full w-full xxs:w-20 xxs:rounded-full"
                                  alt={item.title}
                                />
                              </td>
                              <td
                                className="px-2 py-2 flex flex-col font-Poppins font-bold text-base xxs:text-sm text-gray-800 dark:text-white"
                                onClick={() => openMealDetailsHandler(item._id)}
                              >
                                <span className="cursor-pointer hover:text-gray-500 transition duration-300 ease-in-out">
                                  {item.title}
                                </span>
