    ...
    <>
      <div>
        {order.loading ? (
          ...
          <>
            <div className="fixed z-30 inset-0 overflow-y-auto mt-20">
              <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                >
                  <div
                    className="absolute inset-0 bg-gray-500 opacity-75 backdrop-blur-md"
                    onClick={closePage}
                  ></div>
                </div>
                <span
                ...
                <div className="z-20 inline-block align-center bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-center sm:max-w-4xl sm:w-full">
                  <Card>
                    <div>
                      <button
                        onClick={closePage}
                        className="absolute top-0 right-0 text-gray-900 font-bold rounded-full p-2 m-2 w-8 h-8 flex items-center justify-center transition-transform duration-200 ease-in-out transform hover:scale-110"
                      >
                        X
                      </button>
                            ...
                            <span
                              className={
                                order.status === "order could not be processed"
                                  ? "flex w-2.5 h-2.5 bg-red-600 rounded-full me-1.5 flex-shrink-0"
                                  : "flex w-2.5 h-2.5 bg-teal-600 rounded-full me-1.5 flex-shrink-0"
                              }
                            ></span>
                            {order.status}
                          </span>
                            ...
                            {order.status === "need to accept" ? (
                              ...
                              <div class="flex items-center">
                                <div class="z-10 flex items-center justify-center w-6 h-6 bg-teal-600 rounded-full ring-0 ring-white dark:bg-teal-900 sm:ring-8 dark:ring-gray-900 shrink-0">
                                  <svg
                                    class="w-2.5 h-2.5 text-teal-100 dark:text-teal-300"
                                    aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 16 12"
                      ...
                      <div className="flex justify-evenly mx-5 mt-4">
                        {order.isClosed ? (
                          <div></div>
                        ) : order.status === "need to accept" ? (
                          <>
